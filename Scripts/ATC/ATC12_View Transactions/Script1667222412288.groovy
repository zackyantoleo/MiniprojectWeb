...
WebUI.click(findTestObject('Object Repository/Transaction/Page_frontend-web/i_Beli_v-icon notranslate fas fa-history th_483648'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Transaction/Page_frontend-web/h1_Transactions'), 0)
